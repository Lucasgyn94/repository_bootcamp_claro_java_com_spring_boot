package dio.me.calculoConsumoAndLimiteDadosMoveis.calculoConsumoDadosMoveis;
...
public class Main {
    ...
    public static int calcularConsumoTotal(String[] consumoSemanal) {
        ...
        for (String consumoString : consumoSemanal) {
            int consumo = Integer.parseInt(consumoString.trim());
            total += consumo;
        }
